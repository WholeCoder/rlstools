...
num_list = []
files = os.listdir(os.path.join(os.getcwd(), "migrations"))
for f in files:
    part = f.split("_")[0]
...
with open(os.path.join(os.getcwd(),"migrations/"+next_available_database_version + "_migration"), 'w') as new_view: # noqa
